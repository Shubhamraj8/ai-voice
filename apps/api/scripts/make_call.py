...
Or set env vars manually on Windows:
    $env:TWILIO_ACCOUNT_SID = "ACa8eb0a61d75db6b2ec702fbe25e3329c"
    $env:TWILIO_AUTH_TOKEN  = "19638e9e266cc42b1d083a8183eb7c4c"
...
TO_NUMBER = sys.argv[1] if len(sys.argv) > 1 else "+917870064448"
